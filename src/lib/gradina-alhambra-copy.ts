...
const FR: Copy = {
  ...
  siblingNote: "Ce n’est pas la série néerlandaise Stichting Alhambra à Alkmaar — cette fondation a sa propre page.",
  aboutTitle: "La salle",
...
export function gradinaAlhambraCopy(locale: string): Copy {
