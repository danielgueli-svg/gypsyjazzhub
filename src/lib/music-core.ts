...
export const ALBUMS: Album[] = [
  ...
  {
    slug: "monaco-swing-ensemble-solitude",
    title: "Solitude",
    year: 2020,
    billed: "Monaco Swing Ensemble",
    artists: ["julia-hornung"],
    note: "Upstroke. Current release listed on juliahornungbass.de.",
    href: "https://juliahornungbass.de/",
    hrefLabel: "juliahornungbass.de",
  },
  {
    slug: "giangiacomo-rosso-kind-of-gipsy",
    title: "Kind of Gipsy",
    year: 2023,
    billed: "Giangiacomo Rosso",
    artists: ["giangiacomo-rosso"],
    note: "Black Seed Records, 23 October 2023. Rosso lead, Giacomo Smith clarinet, Mathieu Chatelain rhythm, Pippi Dimonte bass. Recorded Divi’s Studio 3–4 February 2023.",
    href: "https://found.ee/HzWoT",
    hrefLabel: "found.ee",
  },
  {
