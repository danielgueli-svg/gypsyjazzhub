...
/**
 * False on the server and during the first client render (hydration), true
 * afterwards. Keeps `isPending` / `user` identical across SSR and hydrate so
 * auth-gated UI cannot trip a hydration mismatch overlay.
 */
