...
const EN: LuthierPageCopy = {
  ...
  lead: "The instrument makers behind the manouche scene. Workshops that build Selmer-Maccaferri style guitars and other gypsy jazz instruments — from one-person workshops to the names everyone on the circuit knows. Double bass luthiers, violin makers and the rest of the chairs belong here too.",
...
const JA: LuthierPageCopy = {
  ...
  lead: "マヌーシュ・シーンの楽器職人。Selmer-Maccaferri スタイルのギターと、そのほかのジプシージャズ楽器を作る工房です。一人の工房から、サーキットが知る名前まで。コントラバス、ヴァイオリン、ほかの椅子もここに入ります。",
...
const TH: LuthierPageCopy = {
  ...
  lead: "ช่างทำเครื่องดนตรีเบื้องหลังซีนมานูช โรงงานที่ทำกีตาร์สไตล์ Selmer-Maccaferri และเครื่อง gypsy jazz อื่น — จากโรงงานคนเดียวถึงชื่อที่วงจรรู้จัก ช่างดับเบิลเบส ไวโอลิน และที่นั่งอื่นก็อยู่ที่นี่",
